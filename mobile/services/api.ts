...
export const vehiclesApi = {
  ...
  update: (id: number, data: Partial<VehiclePayload>) => api.put(`/vehicles/${id}`, data),
...
export const maintenancesApi = {
  listByVehicle: (vehicleId: number) => api.get(`/maintenances/vehicle/${vehicleId}`),
  create: (data: MaintenancePayload) => api.post('/maintenances', data),
  update: (id: number, data: Partial<MaintenancePayload>) => api.put(`/maintenances/${id}`, data),
